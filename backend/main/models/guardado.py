...
#     def to_json(self):
#         self.fk_user_guardado = db.session.query(UsuarioModel).get_or_404(self.fk_idUser)
#         self.fk_libro_guardado = db.session.query(LibroModel).get_or_404(self.fk_idLibro)
#         guardado_json = {
